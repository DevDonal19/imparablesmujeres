              ...
              <Stack spacing={2.5}>
                <Box>
                  <Typography variant="h6" fontWeight={700} color="primary.main" gutterBottom>
                    Maria Camila Chaverra
                  </Typography>
                  <Typography color="text.secondary" sx={{ lineHeight: 1.7 }}>
                    Impulsa los procesos de comunicación y narrativas digitales.
                  </Typography>
                </Box>
                <Box>
                  <Typography variant="h6" fontWeight={700} color="primary.main" gutterBottom>
                  ...
                  <Typography color="text.secondary" sx={{ lineHeight: 1.7 }}>
                    Lidera la formación en justicia de género y la articulación con liderazgos comunitarios.
                  </Typography>
                </Box>
                <Box>
                  <Typography variant="h6" fontWeight={700} color="primary.main" gutterBottom>
                  ...
                  <Typography color="text.secondary" sx={{ lineHeight: 1.7 }}>
                    Acompaña los procesos psicojurídicos y las redes de cuidado.
                  </Typography>
                </Box>
                <Box>
                  <Typography variant="h6" fontWeight={700} color="primary.main" gutterBottom>
                  ...
                  <Typography color="text.secondary" sx={{ lineHeight: 1.7 }}>
                    Dinamiza los laboratorios creativos para niñas y adolescentes.
                  </Typography>
                </Box>
                <Typography
                  sx={{
